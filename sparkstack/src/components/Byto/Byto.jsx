    ...
    return(
        ...
        <Header/>
            ...
            <div className="container-fluid cont">
                    ...
                    <div className="column">
                        <div className="card1 cardh mt-5">
                            ...
                            <div className="card-text txt">RNTBCI PL</div>
                                ...
                                <div className="card-text txtb">India</div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row" style={{marginTop: -32 + 'px'}}>
                    ...
                    <div className="column">
                        <div className="card1 cardh mt-5">
                            ...
                            <img src="img/logo.png" height={'20px'} alt="..."></img>
                            <div className="card-text txt">RNTBCI PL</div>
                                <div className="card-title">A newfound quasicrystal formed in the first atomic bomb testesd in US</div>
                                <div className="card-text txt">Date: 10/02/2024</div>
                                <div className="card-text txtb">India</div>
                            </div>
                        </div>
                    </div>
