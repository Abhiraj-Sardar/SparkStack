...
const Footer = () => {
    return (
        <>
            ...
            <footer
                class="flex flex-col items-center dark:bg-gray-900 text-center text-white">
                <div class="container px-6 pt-6">
                    ...
                    <div class="mb-6 flex justify-center">
                        <a
                            href="#!"
                            type="button"
                            class="m-1 h-9 w-9 rounded-full border-2 border-red-600 uppercase leading-normal transition duration-150 ease-in-out hover:bg-opacity-1 hover:bg-red-700 focus:outline-none focus:ring-0"
                            data-te-ripple-init
                            data-te-ripple-color="light">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="mx-auto h-full w-4 text-red-600 hover:text-white"
                                fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                        ...
                        <form action="">
                            <div
                                ...
                                <div class="mb-6 md:mr-auto">
                                    <button
                                        type="submit"
                                        class="inline-block rounded border-2 border-red-800 px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-neutral-100 transition duration-150 ease-in-out hover:border-red-100 hover:bg-red-500 hover:bg-opacity-10 hover:text-red-100 focus:border-red-100 focus:text-red-100 focus:outline-none focus:ring-0 active:border-neutral-200 active:text-red-200 dark:hover:bg-red-100 dark:hover:bg-opacity-10 "
                                        // data-te-ripple-init
                                        data-te-ripple-color="light" style={{ color: '#FE0000' }}>
                                        Subscribe
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4">
                        <div class="mb-6">
                            <h5 className="mb-2.5 font-bold uppercase" style={{ color: '#FE0000' }}>Tech Events</h5>

                            <ul class="mb-0 list-none">
                                <li>
                                    <a href="#!" class="text-white">Tech Link 1</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Tech Link 2</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Tech Link 3</a>
                                </li>
                                <li>
                                    <a href="#!" class="text-white">Tech Link 4</a>
                                </li>
                            </ul>
                        </div>

                        <div class="mb-6">
                            <h5 class="mb-2.5 font-bold uppercase" style={{ color: '#FE0000' }}>About Us</h5>

                            <ul class="mb-0 list-none">
                                <li><a href="#!" class="text-white">Career</a></li>
                                <li><a href="#!" class="text-white">Announcements</a></li>
                                <li><a href="#!" class="text-white">External Links</a></li>
                                <li><a href="#!" class="text-white">Collab</a></li>
                            </ul>
                        </div>

                        <div class="mb-6">
                            <h5 class="mb-2.5 font-bold uppercase" style={{ color: '#FE0000' }}>Links</h5>
